...
Targets come from config (books / pages / streak). Progress is computed against
this year's Wrapped + current stats. A target of 0 means "no goal set" and is
omitted, so the Goals section only appears when you actually set one.
"""
